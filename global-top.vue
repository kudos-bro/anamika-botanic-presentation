...
.edge{
  ...
  z-index:40;padding:0 16px;opacity:0;transition:opacity .2s ease;
  color:#7C9B57;-webkit-tap-highlight-color:transparent;
}
.edge-l{left:0;justify-content:flex-start;background:linear-gradient(90deg, rgba(124,155,87,.08), transparent 85%);}
.edge-r{right:0;justify-content:flex-end;background:linear-gradient(270deg, rgba(124,155,87,.08), transparent 85%);}
.edge:hover, .edge:focus-visible{opacity:.85;outline:none;}
.chev{
  width:40px;height:40px;border-radius:50%;display:flex;align-items:center;justify-content:center;
  background:rgba(251,250,244,.35);box-shadow:0 2px 8px rgba(60,75,44,.08);
  border:1px solid rgba(124,155,87,.2);backdrop-filter:blur(1px);
